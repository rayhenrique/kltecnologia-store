            ...
            <header class="sticky top-0 z-30 flex h-16 shrink-0 items-center justify-between border-b border-slate-200 bg-white/95 px-4 sm:px-6 lg:px-8 backdrop-blur-md">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="inline-flex items-center gap-1 font-mono text-xs font-semibold text-emerald-600 bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded-md">
                            ...
                            <span class="hidden sm:inline">Admin Conectado</span>
                            <span class="sm:hidden text-[10px]">Admin</span>
                        </span>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-1.5 sm:gap-3">
                    <a 
                        ...
                        class="inline-flex items-center gap-1 sm:gap-1.5 rounded-xl bg-teal-600 hover:bg-teal-500 px-2.5 sm:px-3.5 py-1.5 text-xs font-bold text-white shadow-sm shadow-teal-600/20 transition"
                    >
                        <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                        <span class="hidden sm:inline">Novo</span> <span>Produto</span>
                    </a>

                    <a 
                        href="{{ route('admin.posts.create') }}" 
                        class="hidden sm:inline-flex items-center gap-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 px-3.5 py-1.5 text-xs font-bold text-white shadow-sm transition"
                    >
                    ...
                    <a 
                        ...
                        target="_blank"
                        class="inline-flex items-center gap-1 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 px-2.5 sm:px-3 py-1.5 text-xs font-semibold text-slate-700 transition"
