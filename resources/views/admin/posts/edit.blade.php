        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-2 self-start sm:self-auto">
                <a 
                    ...
                    target="_blank"
                    class="btn-secondary text-xs !min-h-10 !px-3.5 flex items-center gap-1.5 shadow-2xs text-teal-800 font-semibold"
                >
                ...
                <a 
                    ...
                    class="btn-secondary text-xs !min-h-10 !px-4 flex items-center gap-2 shadow-2xs text-slate-700 font-semibold"
                >
