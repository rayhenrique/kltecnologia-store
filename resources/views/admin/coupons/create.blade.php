<x-admin-layout title="Novo Cupom de Desconto">
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                <nav class="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1" aria-label="Breadcrumb">
                    ...
                    <span>/</span>
                    <span class="text-slate-900 font-bold">Novo Cadastro</span>
                </nav>
                <h1 class="font-display text-2xl font-bold tracking-tight text-slate-900">
                    Cadastrar Novo Cupom
                </h1>
                <p class="text-xs text-slate-500 mt-0.5">
                    Defina o código, percentual ou valor fixo e as regras de aplicação.
                </p>
            </div>
        ...
        <form 
            ...
            x-data="{
                ...
                scope: '{{ old('product_id') ? 'specific' : 'storewide' }}'
            }"
            class="space-y-6"
        >
            @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                name="discount_value" 
                                value="{{ old('discount_value', '10.00') }}" 
                                required 
                                placeholder="10.00" 
